 ...
 *
 * The declarations here have to be in a header file, becasue they need
...
/* This major device number. We can not rely on dynamic registeration
...
/* Get the massage of the device driver */
